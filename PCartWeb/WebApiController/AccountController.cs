...
using PCartWeb.App_Start;
using PCartWeb.Models;
using PCartWeb.Providers;
...
namespace PCartWeb.WebApiController
{
    ...
    public class AccountController : ApiController
    {
        ...
        // POST api/Account/LoginMobileAsync
        [System.Web.Http.HttpPost]
        [Route("LoginMobileAsync")]
        public async Task<IHttpActionResult> LoginMobileAsync(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            ClaimsIdentity oAuthIdentity = await user.GenerateUserIdentityAsync2(userManager,
               OAuthDefaults.AuthenticationType);
            ClaimsIdentity cookiesIdentity = await user.GenerateUserIdentityAsync2(userManager,
                CookieAuthenticationDefaults.AuthenticationType);
